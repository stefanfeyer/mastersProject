    ...
    void Start()
    {
        ...
        switch (serial)
        {
            ...
            case "LHR-89131158":
                ...
                Debug.Log("Found device with ID LHR-89131158 (B8, Box1). I assing Box1 with device index: " + i);
                break;
            case "LHR-31D0CDF2":
                studentLH.GetComponent<SteamVR_TrackedObject>().SetDeviceIndex((int)i);
                Debug.Log("Found device with ID LHR-31D0CDF2 (B9, LHand). I assing LHand with device index: " + i);
                break;
            case "LHR-CAC69A3C":
