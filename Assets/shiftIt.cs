...
public class shiftIt : MonoBehaviour
{
    ...
    {   //Vector3 deltaStudentTeacher = studentHip.transform.position - (teacherHip.transform.position - teacherZero.transform.position);
        ...
        {
            //
            //Vector3 deltaStudentTeacher = (teacherZero.transform.position + teacherHipReference.transform.position) - studentZero.transform.position;
            //Vector3 deltaStudentTeacher = studentHip.transform.position - (teacherHipReference.transform.position - teacherZero.transform.position);
            //this.transform.position = studentHip.transform.position - deltaStudentTeacher;
            
            //this.transform.position = teacherHipReference.transform.position;
